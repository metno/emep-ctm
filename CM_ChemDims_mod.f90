! <CM_ChemDims_mod.f90 - A component of the EMEP MSC-W Chemical transport Model, version v5.5>
!*****************************************************************************!
!*
...
module ChemDims_mod
  ...
  implicit none
  character(len=*),parameter, public :: CM_schemes_ChemDims = " EmChem19c PM_VBS_EmChem19 Aqueous_EmChem19c Aero2024 ShipNOx PM_FFireInert SeaSalt DustExtended Ash PM_ResNonResInert BVOC_SQT_NV BVOC_IsoMT1_emis Pollen"
    ...
    ! No. emission Specss
    integer, parameter, public :: NEMIS_Specs = 59
