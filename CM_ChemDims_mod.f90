! <CM_ChemDims_mod.f90 - A component of the EMEP MSC-W Chemical transport Model, version rv4.45>
!*****************************************************************************!
!*
...
module ChemDims_mod
  ...
  implicit none
  character(len=*),parameter, public :: CM_schemes_ChemDims = " EmChem19a PM_VBS_EmChem19 Aqueous_EmChem16x Aero2017nx ShipNOx PM_FFireInert SeaSalt DustExtended Ash PM_ResNonResInert BVOC_SQT_NV BVOC_IsoMT1_emis Pollen"
  

    ! NSPEC for TOT : All reacting species
    integer, public, parameter :: NSPEC_TOT=130
    
    ! NSPEC for ADV : Advected species
    integer, public, parameter :: NSPEC_ADV=116
    
    ! NSPEC for SHL : Short-lived (non-advected) species
    integer, public, parameter :: NSPEC_SHL=14
