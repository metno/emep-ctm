...
use Io_ml ,               only: ios, datewrite, PrintLog, IO_LOG
...
subroutine BLPhysics()
  ...
  ! Some code moved to BLPhysics_ml, together with additinal options.
  ...
  call CheckStop(KZ_SBL_LIMIT < 1.01*KZ_MINIMUM, "SBLlimit too low! in Met_ml")
