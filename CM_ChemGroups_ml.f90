! <CM_ChemGroups_ml.f90 - A component of the EMEP MSC-W Chemical transport Model, version rv4_5(2809)>
!*****************************************************************************!
!*
...
integer, public, target, save, dimension(22) :: &
  AOD_GROUP = (/ DUST_ROAD_C,DUST_ROAD_F,DUST_SAH_C,DUST_SAH_F,DUST_WB_C,DUST_WB_F,EC_F_FFUEL_AGE,EC_F_FFUEL_NEW,EC_F_WOOD_AGE,EC_F_WOOD_NEW,FFIRE_BC,FFIRE_OM,FFIRE_REMPPM25,NH4_F,NO3_C,NO3_F,PART_OM_F,REMPPM25,REMPPM_C,SEASALT_C,SEASALT_F,SO4 /)
...
integer, public, parameter, dimension(1) :: &
  RO2_POOL      = (/ -99 /)
type(typ_sp), dimension(131), public, save :: chemgroups
...
subroutine Init_ChemGroups()
  ...
  chemgroups(18)%name="WDEP_NVFFUELOC_COARSE"
  chemgroups(18)%ptr=>WDEP_NVFFUELOC_COARSE_GROUP

  chemgroups(19)%name="PM10"
  chemgroups(19)%ptr=>PM10_GROUP

  chemgroups(20)%name="WDEP_PWOODOA25"
  chemgroups(20)%ptr=>WDEP_PWOODOA25_GROUP

  chemgroups(21)%name="DDEP_ASOA"
  chemgroups(21)%ptr=>DDEP_ASOA_GROUP

  chemgroups(22)%name="OX"
  chemgroups(22)%ptr=>OX_GROUP

  chemgroups(23)%name="DDEP_OXN"
  chemgroups(23)%ptr=>DDEP_OXN_GROUP

  chemgroups(24)%name="WDEP_PFFUELOA25"
  chemgroups(24)%ptr=>WDEP_PFFUELOA25_GROUP

  chemgroups(25)%name="DDEP_PPM10"
  chemgroups(25)%ptr=>DDEP_PPM10_GROUP

  chemgroups(26)%name="WDEP_PPM_C"
  chemgroups(26)%ptr=>WDEP_PPM_C_GROUP

  chemgroups(27)%name="DDEP_PPM25_FIRE"
  chemgroups(27)%ptr=>DDEP_PPM25_FIRE_GROUP

  chemgroups(28)%name="WDEP_EC_F"
  chemgroups(28)%ptr=>WDEP_EC_F_GROUP

  chemgroups(29)%name="DDEP_PM10"
  chemgroups(29)%ptr=>DDEP_PM10_GROUP

  chemgroups(30)%name="WDEP_SIA"
  chemgroups(30)%ptr=>WDEP_SIA_GROUP

  chemgroups(31)%name="BVOC"
  chemgroups(31)%ptr=>BVOC_GROUP

  chemgroups(32)%name="PWOODOA25"
  chemgroups(32)%ptr=>PWOODOA25_GROUP

  chemgroups(33)%name="EC_F"
  chemgroups(33)%ptr=>EC_F_GROUP

  chemgroups(34)%name="DDEP_NONVOLPCM"
  chemgroups(34)%ptr=>DDEP_NONVOLPCM_GROUP

  chemgroups(35)%name="WDEP_NVFFIREOC25"
  chemgroups(35)%ptr=>WDEP_NVFFIREOC25_GROUP

  chemgroups(36)%name="SOX"
  chemgroups(36)%ptr=>SOX_GROUP

  chemgroups(37)%name="DUST_ANT_F"
  chemgroups(37)%ptr=>DUST_ANT_F_GROUP

  chemgroups(38)%name="PMFINE"
  chemgroups(38)%ptr=>PMFINE_GROUP

  chemgroups(39)%name="DDEP_NVABSOM"
  chemgroups(39)%ptr=>DDEP_NVABSOM_GROUP

  chemgroups(40)%name="WDEP_SVFFIREOA25"
  chemgroups(40)%ptr=>WDEP_SVFFIREOA25_GROUP

  chemgroups(41)%name="NONVOLPCM"
  chemgroups(41)%ptr=>NONVOLPCM_GROUP

  chemgroups(42)%name="WDEP_DUST_NAT_C"
  chemgroups(42)%ptr=>WDEP_DUST_NAT_C_GROUP

  chemgroups(43)%name="PMCO"
  chemgroups(43)%ptr=>PMCO_GROUP

  chemgroups(44)%name="DDEP_DUST_ANT_F"
  chemgroups(44)%ptr=>DDEP_DUST_ANT_F_GROUP

  chemgroups(45)%name="DDEP_OMCOARSE"
  chemgroups(45)%ptr=>DDEP_OMCOARSE_GROUP

  chemgroups(46)%name="NVFFIREOC25"
  chemgroups(46)%ptr=>NVFFIREOC25_GROUP

  chemgroups(47)%name="WDEP_RDN"
  chemgroups(47)%ptr=>WDEP_RDN_GROUP

  chemgroups(48)%name="WDEP_ASOA"
  chemgroups(48)%ptr=>WDEP_ASOA_GROUP

  chemgroups(49)%name="WDEP_NVWOODOC25"
  chemgroups(49)%ptr=>WDEP_NVWOODOC25_GROUP

  chemgroups(50)%name="DDEP_NVWOODOC25"
  chemgroups(50)%ptr=>DDEP_NVWOODOC25_GROUP

  chemgroups(51)%name="WDEP_ECFINE"
  chemgroups(51)%ptr=>WDEP_ECFINE_GROUP

  chemgroups(52)%name="WDEP_ECCOARSE"
  chemgroups(52)%ptr=>WDEP_ECCOARSE_GROUP

  chemgroups(53)%name="OXN"
  chemgroups(53)%ptr=>OXN_GROUP

  chemgroups(54)%name="WDEP_DUST_ANT_F"
  chemgroups(54)%ptr=>WDEP_DUST_ANT_F_GROUP

  chemgroups(55)%name="DDEP_NVFFUELOC25"
  chemgroups(55)%ptr=>DDEP_NVFFUELOC25_GROUP

  chemgroups(56)%name="SIA"
  chemgroups(56)%ptr=>SIA_GROUP

  chemgroups(57)%name="DDEP_NVFFIREOC25"
  chemgroups(57)%ptr=>DDEP_NVFFIREOC25_GROUP

  chemgroups(58)%name="DDEP_TNO3"
  chemgroups(58)%ptr=>DDEP_TNO3_GROUP

  chemgroups(59)%name="DDEP_PMCO"
  chemgroups(59)%ptr=>DDEP_PMCO_GROUP

  chemgroups(60)%name="DDEP_BSOA"
  chemgroups(60)%ptr=>DDEP_BSOA_GROUP

  chemgroups(61)%name="DDEP_PCM"
  chemgroups(61)%ptr=>DDEP_PCM_GROUP

  chemgroups(62)%name="DDEP_NVFFUELOC_COARSE"
  chemgroups(62)%ptr=>DDEP_NVFFUELOC_COARSE_GROUP

  chemgroups(63)%name="ECCOARSE"
  chemgroups(63)%ptr=>ECCOARSE_GROUP

  chemgroups(64)%name="WOODEC"
  chemgroups(64)%ptr=>WOODEC_GROUP

  chemgroups(65)%name="WDEP_TNO3"
  chemgroups(65)%ptr=>WDEP_TNO3_GROUP

  chemgroups(66)%name="DDEP_DUST_ANT_C"
  chemgroups(66)%ptr=>DDEP_DUST_ANT_C_GROUP

  chemgroups(67)%name="WDEP_PMCO"
  chemgroups(67)%ptr=>WDEP_PMCO_GROUP

  chemgroups(68)%name="DDEP_FFUELEC"
  chemgroups(68)%ptr=>DDEP_FFUELEC_GROUP

  chemgroups(69)%name="WDEP_NVFFUELOC25"
  chemgroups(69)%ptr=>WDEP_NVFFUELOC25_GROUP

  chemgroups(70)%name="WDEP_PM10ANTHR"
  chemgroups(70)%ptr=>WDEP_PM10ANTHR_GROUP

  chemgroups(71)%name="WDEP_SVFFUELOA25"
  chemgroups(71)%ptr=>WDEP_SVFFUELOA25_GROUP

  chemgroups(72)%name="DDEP_PPM25"
  chemgroups(72)%ptr=>DDEP_PPM25_GROUP

  chemgroups(73)%name="WDEP_PPM25_FIRE"
  chemgroups(73)%ptr=>WDEP_PPM25_FIRE_GROUP

  chemgroups(74)%name="FFIREBC"
  chemgroups(74)%ptr=>FFIREBC_GROUP

  chemgroups(75)%name="WDEP_FFIREBC"
  chemgroups(75)%ptr=>WDEP_FFIREBC_GROUP

  chemgroups(76)%name="NOX"
  chemgroups(76)%ptr=>NOX_GROUP

  chemgroups(77)%name="SS"
  chemgroups(77)%ptr=>SS_GROUP

  chemgroups(78)%name="DUST_NAT_F"
  chemgroups(78)%ptr=>DUST_NAT_F_GROUP

  chemgroups(79)%name="DDEP_DUST"
  chemgroups(79)%ptr=>DDEP_DUST_GROUP

  chemgroups(80)%name="RO2"
  chemgroups(80)%ptr=>RO2_GROUP

  chemgroups(81)%name="DDEP_EC_F"
  chemgroups(81)%ptr=>DDEP_EC_F_GROUP

  chemgroups(82)%name="ROOH"
  chemgroups(82)%ptr=>ROOH_GROUP

  chemgroups(83)%name="DUST_ANT_C"
  chemgroups(83)%ptr=>DUST_ANT_C_GROUP

  chemgroups(84)%name="AOD"
  chemgroups(84)%ptr=>AOD_GROUP

  chemgroups(85)%name="DDEP_PPM_C"
  chemgroups(85)%ptr=>DDEP_PPM_C_GROUP

  chemgroups(86)%name="WDEP_NVABSOM"
  chemgroups(86)%ptr=>WDEP_NVABSOM_GROUP

  chemgroups(87)%name="SVFFUELOA25"
  chemgroups(87)%ptr=>SVFFUELOA25_GROUP

  chemgroups(88)%name="DDEP_SOX"
  chemgroups(88)%ptr=>DDEP_SOX_GROUP

  chemgroups(89)%name="WDEP_DUST_NAT_F"
  chemgroups(89)%ptr=>WDEP_DUST_NAT_F_GROUP

  chemgroups(90)%name="WDEP_SOX"
  chemgroups(90)%ptr=>WDEP_SOX_GROUP

  chemgroups(91)%name="PFFUELOA25"
  chemgroups(91)%ptr=>PFFUELOA25_GROUP

  chemgroups(92)%name="FFUELEC"
  chemgroups(92)%ptr=>FFUELEC_GROUP

  chemgroups(93)%name="PM10ANTHR"
  chemgroups(93)%ptr=>PM10ANTHR_GROUP

  chemgroups(94)%name="WDEP_DUST_ANT_C"
  chemgroups(94)%ptr=>WDEP_DUST_ANT_C_GROUP

  chemgroups(95)%name="DDEP_DUST_NAT_F"
  chemgroups(95)%ptr=>DDEP_DUST_NAT_F_GROUP

  chemgroups(96)%name="DDEP_PM10ANTHR"
  chemgroups(96)%ptr=>DDEP_PM10ANTHR_GROUP

  chemgroups(97)%name="DDEP_WOODEC"
  chemgroups(97)%ptr=>DDEP_WOODEC_GROUP

  chemgroups(98)%name="WDEP_WOODEC"
  chemgroups(98)%ptr=>WDEP_WOODEC_GROUP

  chemgroups(99)%name="WDEP_PCM"
  chemgroups(99)%ptr=>WDEP_PCM_GROUP

  chemgroups(100)%name="WDEP_SS"
  chemgroups(100)%ptr=>WDEP_SS_GROUP

  chemgroups(101)%name="DUST_NAT_C"
  chemgroups(101)%ptr=>DUST_NAT_C_GROUP

  chemgroups(102)%name="WDEP_NONVOLPCM"
  chemgroups(102)%ptr=>WDEP_NONVOLPCM_GROUP

  chemgroups(103)%name="PPM25"
  chemgroups(103)%ptr=>PPM25_GROUP

  chemgroups(104)%name="ASOA"
  chemgroups(104)%ptr=>ASOA_GROUP

  chemgroups(105)%name="NVABSOM"
  chemgroups(105)%ptr=>NVABSOM_GROUP

  chemgroups(106)%name="PPM10"
  chemgroups(106)%ptr=>PPM10_GROUP

  chemgroups(107)%name="BSOA"
  chemgroups(107)%ptr=>BSOA_GROUP

  chemgroups(108)%name="ECFINE"
  chemgroups(108)%ptr=>ECFINE_GROUP

  chemgroups(109)%name="DDEP_FFIREBC"
  chemgroups(109)%ptr=>DDEP_FFIREBC_GROUP

  chemgroups(110)%name="WDEP_DUST"
  chemgroups(110)%ptr=>WDEP_DUST_GROUP

  chemgroups(111)%name="NVFFUELOC_COARSE"
  chemgroups(111)%ptr=>NVFFUELOC_COARSE_GROUP

  chemgroups(112)%name="DDEP_ECFINE"
  chemgroups(112)%ptr=>DDEP_ECFINE_GROUP

  chemgroups(113)%name="WDEP_ROOH"
  chemgroups(113)%ptr=>WDEP_ROOH_GROUP

  chemgroups(114)%name="PCM"
  chemgroups(114)%ptr=>PCM_GROUP

  chemgroups(115)%name="SVWOODOA25"
  chemgroups(115)%ptr=>SVWOODOA25_GROUP

  chemgroups(116)%name="DDEP_SIA"
  chemgroups(116)%ptr=>DDEP_SIA_GROUP

  chemgroups(117)%name="WDEP_PFFIREOA25"
  chemgroups(117)%ptr=>WDEP_PFFIREOA25_GROUP

  chemgroups(118)%name="PCM_HELP"
  chemgroups(118)%ptr=>PCM_HELP_GROUP

  chemgroups(119)%name="WDEP_OMCOARSE"
  chemgroups(119)%ptr=>WDEP_OMCOARSE_GROUP

  chemgroups(120)%name="TNO3"
  chemgroups(120)%ptr=>TNO3_GROUP

  chemgroups(121)%name="SVFFIREOA25"
  chemgroups(121)%ptr=>SVFFIREOA25_GROUP

  chemgroups(122)%name="DDEP_DAOBS"
  chemgroups(122)%ptr=>DDEP_DAOBS_GROUP

  chemgroups(123)%name="NVFFUELOC25"
  chemgroups(123)%ptr=>NVFFUELOC25_GROUP

  chemgroups(124)%name="OMCOARSE"
  chemgroups(124)%ptr=>OMCOARSE_GROUP

  chemgroups(125)%name="DDEP_ROOH"
  chemgroups(125)%ptr=>DDEP_ROOH_GROUP

  chemgroups(126)%name="WDEP_PMFINE"
  chemgroups(126)%ptr=>WDEP_PMFINE_GROUP

  chemgroups(127)%name="DDEP_RDN"
  chemgroups(127)%ptr=>DDEP_RDN_GROUP

  chemgroups(128)%name="PFFIREOA25"
  chemgroups(128)%ptr=>PFFIREOA25_GROUP

  chemgroups(129)%name="RDN"
  chemgroups(129)%ptr=>RDN_GROUP

  chemgroups(130)%name="DAOBS"
  chemgroups(130)%ptr=>DAOBS_GROUP

  chemgroups(131)%name="WDEP_FFUELEC"
  chemgroups(131)%ptr=>WDEP_FFUELEC_GROUP
