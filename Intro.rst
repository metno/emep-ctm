...
rv4.36. It is intended primarily as a guide on how to run the model, and
...
The latest release Open Source of the EMEP/MSC-W model is `version rv4_36`__.
This and previous releases can be found on the `releases section`__
of the EMEP/MSC-W Open Source `github page`__.

.. __: https://github.com/metno/emep-ctm/releases/tag/rv4_36
...
.. code-block:: bash
    ...
    # download the source code for rv4_36 release
    catalog.py -R rv4_36 --source


The model source code, makefiles, and a copy of the license file
will be placed under the directory ``EMEP_MSC-W_model.rv4.36.OpenSource/source/``.
