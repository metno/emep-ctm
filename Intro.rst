...
rv4.33. It is intended primarily as a guide on how to run the model, and
...
will be placed under the directory ``EMEP_MSC-W_model.rv4.33.OpenSource/source/``.
...
placed in the ``EMEP_MSC-W_model.rv4.33.OpenSource`` directory. The run script,
