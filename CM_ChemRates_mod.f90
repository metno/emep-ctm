! <CM_ChemRates_mod.f90 - A component of the EMEP MSC-W Chemical Transport Model, version v5.8>
!*****************************************************************************!
!*
...
module ChemRates_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemRates = "EmChem19c PM_VBS_EmChem19 Aqueous_EmChem19c Aero2026 ClNO2 ShipNOx PM_FFireInert SeaSalt DustExtended Ash2bin PM_ResNonResInert BVOC_SQT_NV BVOC_IsoMT1_emis"
...
contains
  ...
  subroutine setChemRates()
    ...
    rct(95,:) = 4.0e-12*FGAS(NON_C_BSOA_UG1e3,  &
              & :)
    rct(96,:) = (IUPAC_TROE(2.8e-31*EXP(2.6*(LOG(300*TINV))),  &
              & 2.0e-12,  &
              & EXP(-TEMP/472.0),  &
              & M,  &
              & 0.75-1.27*(-TEMP/472.0)/LOG(10.0)))*FGAS(SO2,  &
              & :)
    ...
    rct(101,:) = UPTAKERATE(CHO2,  &
               ...
               & S=S_M2M3(AERO%PM,  &
               & :))
    rct(102,:) = 2.40e-12*EXP(-1250.0*TINV)
    rct(103,:) = EC_AGEING_RATE()
